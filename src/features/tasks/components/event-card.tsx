...
const statusColorMap: Record<TaskStatus, string> = {
  [TaskStatus.BACKLOG]: 'border-l-neutral-300',
  [TaskStatus.TODO]: 'border-l-neutral-400',
  [TaskStatus.IN_PROGRESS]: 'border-l-neutral-500',
  [TaskStatus.IN_REVIEW]: 'border-l-neutral-600',
  [TaskStatus.DONE]: 'border-l-neutral-700',
};
