...
const statusIconMap: Record<TaskStatus, React.ReactNode> = {
  [TaskStatus.BACKLOG]: <CircleDashed className="size-[18px] text-neutral-400" />,
  [TaskStatus.TODO]: <Circle className="size-[18px] text-neutral-500" />,
  [TaskStatus.IN_PROGRESS]: <CircleDotDashed className="size-[18px] text-neutral-600" />,
  [TaskStatus.IN_REVIEW]: <CircleDot className="size-[18px] text-neutral-700" />,
  [TaskStatus.DONE]: <CircleCheck className="size-[18px] text-neutral-800" />,
};
